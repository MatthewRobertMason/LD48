...
public class DrillController : MonoBehaviour
{
    ...
    private void MoveCharacter()
    {
        ...
        Vector3 pos = new Vector3(
            (this.transform.position.x + gauge.transform.position.x) / 2.0f, 
            (this.transform.position.y + gauge.transform.position.y) / 2.0f,
            0.0f);

        levelManager.ClearFogOfWar(position.x, position.y, visionRadius);

        GameObject mask = Instantiate(levelManager.FogMaskCircle, pos, levelManager.FogMaskCircle.transform.rotation, levelManager.FogMaskTransform);
        ...
        GameObject squareMask = Instantiate(levelManager.FogMaskSquare, squareMaskPos, levelManager.FogMaskCircle.transform.rotation, levelManager.FogMaskTransform);
        ...
        {
            squareMask.transform.rotation = Quaternion.Euler(0.0f, 0.0f, 90.0f);
        }
